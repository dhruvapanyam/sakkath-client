...
export function LandingCard({value}){
    ...
    return <Grid item xs={6} padding={2}>
                <div style={{width:'100%',aspectRatio:1, color: 'black',backgroundColor: 1 ? 'white' : 'rgb(227, 109, 172)', background: 'linear-gradient(240deg, white 30%, rgb(227, 109, 172) 100%)', borderRadius:'20px', border:'2px solid black', boxShadow:'10px 10px rgb(28, 147, 214)'}}>
